/**
 * Hydrates hub state once and listens for push updates.
 * Location: packages/inspector-app/src/hooks/useInspectorState.ts
 */

import { useEffect, useRef, useState } from 'react';
import { listen } from '@tauri-apps/api/event';
import { getState, STATE_EVENT } from '../api.js';
